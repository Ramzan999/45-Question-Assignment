...
let nam:string = "Ramzan";
console.log(`Hello ${nam}, would you like to learn TypeScript today?`);

// Question 3

let aliMurtza: String = "Ramzan saleh"

let lowerCaseName: string = aliMurtza.toLowerCase();
console.log(lowerCaseName)

let upperCaseName: string = aliMurtza.toUpperCase();
console.log(upperCaseName)

let words: string[]=aliMurtza.split(" ");
...
let quote: string = `William Faulkner once said, “It may be bad, but its the only way you can do anything really good”.`;
console.log(quote);

// Question 5

let famous_person: string = "paulo_coelho";
var message: string = `“Tears are words that need to be written”.`
console.log(`${famous_person} once said,${message}`);

// Question 6
let person_name:string = "\t Ramzan Mandra \t\n";
console.log("Name with white spaces:", person_name);
let strippigName:string = person_name.trim();
...
var message:string = `My favorit number is: ${favoritNumber}`;
console.log(message);
...
let Author: string = "paulo_coelho";
var message: string = `“Tears are words that need to be written”.`
console.log(`${Author} once said,${message}`);

// Question 11 
var names:string[] = ["Muhammad", "Ali", "Ahmed", "waqas", "Feroze", "Imran"]
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
// Question 13
let favoritTransportation:Array<[transport:string, brand:string]> = [];
...
favoritTransportation.forEach(([transport, brand]) =>
...
let travelDestination:string [] = ["Tokyo", "Paris", "Istanbul", "Madina Munawar", "Cayman", "Newyork"];
...
const cities:string[] = ["Karachi", "Lahor", "islamabad", "bejing", "delhi"];
...
function displayProducts(products: Array<typeof product>) 
{
...
// Question 29 
const favorit_fruits:string [] = ["apple", "strawberry", "banana"] 
...
// Question 31
let userNames:string [] = ["admin", "ali", "Razzaq", "Ahmed", "Ramiz"]
